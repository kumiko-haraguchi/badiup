...
class _NewColorPageState extends State<AdminNewColorPage> {
  ...
  Widget _buildTextColorDropdown() {
    ...
    return Padding(
        padding: const EdgeInsets.fromLTRB(16.0, 240.0, 16.0, 60.0),
  ...
  Widget _buildSubmitButton() {
    return Padding(
      padding: const EdgeInsets.fromLTRB(16.0, 320.0, 16.0, 60.0),
      child: RaisedButton(
  ...
  Future<void> _submitForm() async {
    ...
    // TODO: Edit
    // if (_updatingExistingColor) {
    //   await Firestore.instance
    //       .collection(constants.DBCollections.colors)
    //       .document(_color.documentId)
    //       .updateData(_colorModel.toMap());
    // } else {
